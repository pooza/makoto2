...
TOPICS = {
  '食べ物・飲み物': [
    ...
    '玉ねぎ', 'たまねぎ', 'たけのこ', 'オムライス', '新米', '味噌汁', 'みそ汁', 'りんご',
    '唐揚げ', 'たまご焼き', '卵焼き', 'かぼちゃ', 'だし', '出汁', '昆布', '佃煮', '焼き魚',
    '煮物', '蕎麦', 'そば湯', '塩', '果物', 'スープ', 'たこ', 'トースト', '飴', 'レモン',
    '豆腐', 'わかめ', '皮を剥', '炊け', '茹で', '刻ん', '火加減', 'ひとつまみ',
  ],
  '歌・仕事': [
    ...
    # +2026-09-05（#225 で足した原稿の語彙）
    'マイク', '楽屋', '拍手', '発声', '声出し', '収録', 'スタジオ', '本番', '楽譜', '振り付け',
    '客席', '喉', '歌詞', '調律', '共演', '合わせ', '照明',
  ],
  '天気・季節': [
    ...
    '日が暮れる',
    # +2026-09-05（#225 で足した原稿の語彙）
    # ⚠ 「風」は風邪・風呂・扇風機に当たるので、助詞まで含めて絞る
    '虹', '霧', '風が', '風の', '風も', '曇り', '陽が', '日差し', '金木犀', '落ち葉', '新緑',
    '雲', '気温', '水たまり',
  ],
  '髪・服・おしゃれ': [

Sequel.migration do
  ...
  #
  # ⚠ **行は増える一方だが 1 日に数本**なので、🔴 **10 年でも 1 万行そこそこ** ＝
  # **掃除の当番は作らない。**⚠ **本数は `/song/timetable` 次第**（🔴 **「1 日 2 本 ＝
  # 10 年で 7,300 行」と書いていたが、#292 で 1 日 3 本になっていた**。⚠⚠ **桁は
  # 変わらないので結論は同じ**。2026-09-19 に直した ＝ #315）。
  change do
